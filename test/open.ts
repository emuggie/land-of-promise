import { OpenPromise } from '../lib/open';
...
let test1:OpenPromise<any> = new OpenPromise<any>((resolve)=>{
...
let test2:OpenPromise<any> = new OpenPromise<any>((resolve, reject)=>{
...
let test3:OpenPromise<any> = new OpenPromise<any>((resolve, reject)=>{
...
let test4:OpenPromise<any> = new OpenPromise<any>((resolve, reject)=>{
